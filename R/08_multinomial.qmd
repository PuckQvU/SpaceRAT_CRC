---
title: "Classification with a multinomial regression model"
...
## Classification using multinomial gression with leave-one-out cross validation
...
write_csv(overall_res, file = "../results/08.MR_overall.csv")
...
write_csv(by_class_res, file = "../results/08.MR_byclass.csv")
...
write_csv(classification_rate, file = "../results/08.MR_classification_rate.csv")
```
