...
CMSclassifier_overall <- read_csv("../results/08.CMSclassifier_overall.csv")
CMSclassifier_byclass <- read_csv("../results/08.CMSclassifier_byclass.csv")
CMSclassifier_classification_rate <- read_csv("../results/08.CMSclassifier_classification_rate.csv")

CMScaller_overall <- read_csv("../results/09.CMScaller_overall.csv")
CMScaller_byclass <- read_csv("../results/09.CMScaller_byclass.csv")
CMScaller_classification_rate <- read_csv("../results/09.CMScaller_classification_rate.csv")

SpaceRAT_DTC_overall <- read_csv("../results/10.SpaceRAT+DTC_overall.csv")
SpaceRAT_DTC_byclass <- read_csv("../results/10.SpaceRAT+DTC_byclass.csv")
SpaceRAT_DTC_classification_rate <- read_csv("../results/10.SpaceRAT+DTC_classification_rate.csv")
```
...
combined_overall <- DTC_overall |> 
  rbind(rDTC_overall, kNN_best_overall, CMSclassifier_best_overall, CMScaller_overall, SpaceRAT_DTC_overall)
...
combined_byclass <- DTC_byclass |> 
  rbind(rDTC_byclass, kNN_best_byclass, CMSclassifier_best_byclass, CMScaller_byclass, SpaceRAT_DTC_byclass)
...
combined_classification_rate <- DTC_classification_rate |> 
  rbind(rDTC_classification_rate, kNN_best_classification_rate, CMSclassifier_best_classification_rate, CMScaller_classification_rate, SpaceRAT_DTC_classification_rate)
